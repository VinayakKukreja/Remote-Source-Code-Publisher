...
namespace CodeAnalysis
{
	...
	template<typename element>
	inline typename size_t ScopeStack<element>::size() { return stack.size(); }

	template<typename element>
	inline typename ScopeStack<element>::iterator ScopeStack<element>::begin() { return stack.begin(); }

	template<typename element>
	inline typename ScopeStack<element>::iterator ScopeStack<element>::end() { return stack.end(); }
	...
	void ScopeStack<element>::push(const element& item)
	{
		...
		//Dbug::write("\n--- stack size = " + UtilitiesParser::Converter<size_t>::toString(size()) + " ---");
		Dbug::flush();
	}
